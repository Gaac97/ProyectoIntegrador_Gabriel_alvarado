...
public class Rebeldes extends Piezas {
    ...
    public boolean comer(int x, int y, Piezas[][] m, int a, int b) {
        ...
        if (x == a) {
            while (cont < y) {
                if ((m[x][cont] instanceof Rebeldes) && (m[x][cont] instanceof Duques) && (m[x][cont] instanceof Rebeldes)) {
                    cont++;
                    return true;
            ...
            if (y == b) {
                while (cont < x) {
                    if ((m[cont][x] instanceof Rebeldes) && (m[cont][x] instanceof Duques) && (m[cont][x] instanceof Rebeldes)) {
                        cont++;
                        return true;
                    }
                    break;
